...
namespace Microsoft.Boogie
{
  ...
  public class CommandLineOptions : CommandLineOptionEngine, ExecutionEngineOptions
  {
    ...
    public string ProofOutputDir { get; private set; } = null;
    public bool OnlyCheckProofGenSupport { get; private set; } = false;
    public bool DontStoreProofGenFiles { get; private set; } = false;
    ...
    public bool UseIdBasedLemmaNaming { get; private set; } = false;
     ...
     */
    public int GenerateIsaProgNoProofs => generateIsaProgNoProofs;
    private int generateIsaProgNoProofs = 0;
    ...
    public bool DesugarMaps { get; private set; } = false;
    #endregion
    ...
    protected override bool ParseOption(string name, CommandLineParseState ps)
    {
      ...
      switch (name)
      {
        ...
        case "isaProgNoProofs":
          ps.GetIntArgument(ref generateIsaProgNoProofs, 3);
          return true;
