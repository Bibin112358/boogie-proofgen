  ...
  void CreateBlocks(StmtList stmtList, string runOffTheEndLabel, AstToCfgProofGenInfo proofGenInfo)
  {
    ...
    foreach (var bigBlock in stmtList.BigBlocks)
    {
      ...
      if (bigBlock.tc != null)
      {
        ...
        #region proofgen
        proofGenInfo.CreateBlockPairingWithHints(bigBlock, block, BranchIndicator.NoGuard, null);
        #endregion
        ...
        switch (bigBlock.ec)
        {
          ...
          case WhileCmd whileCmd:
          {
            ...
            if (!bodyGuardTakenCareOf)
            {
              ...
              #region proofgen
              BigBlock loopBodyBeginning = whileCmd.Body.BigBlocks[0];
              proofGenInfo.CreateBlockPairingWithHints(loopBodyBeginning, block, BranchIndicator.GuardHolds, whileCmd.Guard);
              #endregion
            }
            ...
            {
              proofGenInfo.AddBigBlockToLoopPair(bb, bigBlock);
            }
            proofGenInfo.AddBigBlockToHintsPair(whileCmd.Body.BigBlocks.First(), (whileCmd.Guard, BranchIndicator.GuardHolds));
            #endregion

            // recurse to create the blocks for the loop body
            CreateBlocks(whileCmd.Body, loopHeadLabel, proofGenInfo);
            ...
            #region proofgen
            BigBlock loopDone = bigBlock.SuccessorBigBlock;
            ...
            if (loopDone == null)
            {
              ...
              bigBlock.SuccessorBigBlock = loopDone;
              ...
              {
                proofGenInfo.AddBigBlockToHintsPair(loopDone, (whileCmd.Guard, BranchIndicator.GuardFails));
              }
          ...
          case IfCmd ifCmd:
          {
            ...
            for (; ifCmd != null; ifCmd = ifCmd.ElseIf)
            {
              ...
              #region proofgen
              proofGenInfo.CreateBlockPairingWithHints(bigBlock, jumpBlock, BranchIndicator.NoGuard, null);
              ...
              if (!thenGuardTakenCareOf)
              {
                ...
                proofGenInfo.CreateBlockPairingWithHints(thnBranchBeginning, thenJumpBlock, BranchIndicator.GuardHolds, ifCmd.Guard);
                #endregion
              }

              // recurse to create the blocks for the then branch
              CreateBlocks(ifCmd.Thn, remainingBigBlocks == 0 ? runOffTheEndLabel : null, proofGenInfo);
              ...
              if (ifCmd.ElseBlock != null)
              {
                ...
                if (!elseGuardTakenCareOf)
                {
                  ...
                  proofGenInfo.CreateBlockPairingWithHints(elseBranchBeginning, elseJumpBlock, BranchIndicator.GuardFails, ifCmd.Guard);
                  #endregion
                }

                // recurse to create the blocks for the else branch
                CreateBlocks(ifCmd.ElseBlock, remainingBigBlocks == 0 ? runOffTheEndLabel : null, proofGenInfo);
              }
